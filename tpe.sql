...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-09-2023 a las 01:34:49
...
INSERT INTO `clubes` (`Id_equipos`, `Nombre`, `Liga`, `Ciudad`) VALUES
...
INSERT INTO `futbolistas` (`Id_jugador`, `Nombre`, `Apellido`, `Edad`, `Pais`, `Id_equipos`) VALUES
...
--
ALTER TABLE `clubes`
  ADD CONSTRAINT `clubes_ibfk_1` FOREIGN KEY (`Id_equipos`) REFERENCES `futbolistas` (`Id_equipos`);
COMMIT;
